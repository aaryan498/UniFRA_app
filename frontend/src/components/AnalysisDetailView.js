      ...
      <div className="bg-white border-b border-gray-200 px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 flex-shrink-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 sm:px-4 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm font-medium rounded-md transition-colors flex items-center space-x-1 sm:space-x-2 flex-shrink-0 shadow-sm"
